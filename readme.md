...
- [ ] **v0.1.0 - Core Implementation (PoC)**
    - [ ] Implement the core download module using `chrome.downloads` API & handle custom Headers (Cookies/Referer) via `declarativeNetRequest`.
    - [ ] Implement the basic interception module for Aria2 JSON-RPC.
